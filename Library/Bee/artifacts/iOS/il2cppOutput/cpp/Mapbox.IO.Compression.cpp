...
IL_0077:
	{
		...
		NullCheck(L_23);
		int32_t L_26;
		L_26 = VirtualFuncInvoker3< int32_t, ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031*, int32_t, int32_t >::Invoke(30, L_23, L_24, 0, ((int32_t)(((RuntimeArray*)L_25)->max_length)));
		V_3 = L_26;
		int32_t L_27 = V_3;
...
CATCH_00e2:
	{
		int32_t* L_47 = (int32_t*)(&__this->___asyncOperations);
		int32_t L_48;
...
IL_009f:
	...
	}
	{
		...
		NullCheck(L_24);
		NullCheck(L_22);
		VirtualActionInvoker3< ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031*, int32_t, int32_t >::Invoke(33, L_22, L_23, 0, ((int32_t)(((RuntimeArray*)L_24)->max_length)));
	}
...
CATCH_0086:
	{
		int32_t* L_29 = (int32_t*)(&__this->___asyncOperations);
		int32_t L_30;
...
IL_0020:
	{
		...
		NullCheck(L_4);
		int32_t L_8;
		L_8 = VirtualFuncInvoker3< int32_t, ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031*, int32_t, int32_t >::Invoke(30, L_4, L_5, L_6, L_7);
		V_1 = L_8;
		goto IL_0031;
	}
...
IL_0020:
	{
		...
		int32_t L_7 = ___2_count;
		NullCheck(L_4);
		VirtualActionInvoker3< ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031*, int32_t, int32_t >::Invoke(33, L_4, L_5, L_6, L_7);
		return;
	}
}
